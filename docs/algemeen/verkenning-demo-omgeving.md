# Notitie verkenning demo-omgeving - DEEL 3
...
## 1 Gebruikers(groep) definiëren
 - Je moet ook heel duidelijk de gebruiker definieeren
 - Eindgebruiker (prioriteit)
 - Software-ontwikkelaar
 - Inwinner
 - Bronhouder
 - Paar groepen defineeren
 - Dat vereist misschien meerdere type demo-omgevingen
 - Zijn die meer teschnische experts niet al geholpen met 
...
## 2 Voor- en nadelen thema bestuurlijke gebieden
 ...
 - Mensen werken al met deze data dus what's new?
 - Het is nu nog een klein onderwerp/nog niet thema-overstijgend
 - Het is wel een enabler voor overheidskant en allerlei andere diensten

## 3 Meerwaarde van informatiemodel DiSGeo
 - Objectgeorienteerd i.p.v. kaart(laag)georiënteerd
 - Je wilt niet afhankelijk zijn van GIS-expert of de geometrie voor een antwoord; geometrie is een stukje van, maar niet noodzakelijk te sleutel tot informatie.
 ...
 - Variabele scope van de context (BG, of BG op land, of Gemeentegebied); een kaartlaag is beperkt de scope tot één objecttype (bijv. Gemeentegebied)
 - In een kaartlaag zijn eigenschappen van objecten vaak platgeslagen (bijv. Gemeente en ~ gebied zijn vaak 'hetzelfde' waarmee hun eigenschappen op één hoop belanden). 
...
## 6 Acties
 - Uitwerken voorbeelden bestaande informatiebronnen
